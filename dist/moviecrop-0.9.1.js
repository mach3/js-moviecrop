...
(function($, undefined){
	...
	$.extend(MovieCrop.prototype, {
		 ...
		 * @param Boolean back reverse or not
		 * @param Function callback Callback function when movie complete.
		 */
		run : function(reverse, callback){
			var go, method;
			callback = $.isFunction(callback) ? callback : function(){};
			method = reverse ? "prevFrame" : "nextFrame";
	...
	$.fn.extend({
		...
		movieReverse : function(config, callback){
			this.each(function(){
				$.initMovieCrop(this, config).reverse(callback);
			});
			return this;
		},
		movieStop : function(){
